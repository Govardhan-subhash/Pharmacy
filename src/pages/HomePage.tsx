  ...
  return (
    <PageTransition>
      ...
      <section className="py-8 bg-gray-100">
        ...
        {/* Full-width Scrolling News Bar */}
        <div className="relative w-full overflow-hidden bg-blue-600 py-3">
          <div
            className="animate-scroll-news flex whitespace-nowrap items-center"
            ref={scrollContainerRef}
          >
            {duplicatedNews.map((item) => (
              <div
                key={item.id}
                className="mx-6 flex-shrink-0 text-white font-semibold cursor-pointer text-lg"
